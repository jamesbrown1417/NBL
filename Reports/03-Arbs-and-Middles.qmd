...
# Display
all_player_points_middles |> slice_head(n = 10)
all_player_assists_middles |> slice_head(n = 10)
all_player_rebounds_middles |> slice_head(n = 10)
all_player_threes_middles |> slice_head(n = 10)
```
