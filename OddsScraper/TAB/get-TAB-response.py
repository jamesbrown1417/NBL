...
OUTPUT_PATH = "/Users/jamesbrown/Projects/NBL/OddsScraper/TAB/tab_response.json"
...
async def main():
    ...
    async with webdriver.Chrome(options=options) as driver:
        ...
        api_url = "https://api.beta.tab.com.au/v1/tab-info-service/sports/Basketball/competitions/NBL?jurisdiction=SA"
